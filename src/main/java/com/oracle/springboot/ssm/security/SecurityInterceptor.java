package com.oracle.springboot.ssm.security;
...
import com.oracle.springboot.ssm.util.JwtUtil;
                ...
                if (handlerMethod.hasMethodAnnotation(NoAuth.class)) {
                    ...
                    if (token == null) {
                        ...
                        try {
                            ...
                            //token不符合规范
                            vo = new ResponseVo("500", null, "payload被篡改,请重新登录！");
                            response.getWriter().write(JSON.toJSONString(vo));
                            return false;
                        }
